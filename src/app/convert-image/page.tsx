...
export default function ConvertImage() {
  return (
    <div role="button" tabIndex={0}>
      ...
      <input
        accept="image/png, image/jpeg, image/bmp, image/heic, image/tiff, image/webp, image/jpg, image/avif"
        multiple
        type="file"
        tabIndex={-1}
        style={{ display: "none" }}
          ...
          <div className="container pt-[90px] space-y-6 lg:relative lg:space-y-0 lg:min-h-[700px] lg:pt-[160px] lg:flex lg:justify-between lg:items-start">
            <div className="lg:pr-4">
              <h1 className="text-neutral-ink-700 mb-4 text-center lg:text-left !leading-tight H30B lg:H56B">
                Đổi định dạng ảnh trong 1 nhấp chuột{" "}
              ...
              <p className="text-neutral-ink-600 text-center lg:text-left T16R lg:T20R">
                Công cụ chuyển đổi ảnh SnapEdit giúp chuyển định dạng PNG sang
                JPG, JPG sang PDF hoặc TIFF sang JPG trong chớp mắt. Chuyển đổi
                chất lượng cao - Tải lên an toàn - Xử lý hàng loạt.
              </p>
            </div>
                    ...
                    <ul className="space-x-3">
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/convert-image/convert-image-demo-1.jpg"
                            alt="sample"
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/convert-image/convert-image-demo-2.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/convert-image/convert-image-demo-3.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/convert-image/convert-image-demo-4.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
            ...
            <div className="lg:w-[670px] lg:absolute lg:bottom-0 lg:left-0">
              <img
                src="https://assets.snapedit.app/images/convert-image/hero_banner_static.webp"
                className="lg:h-[327px]"
              />
            </div>
          </div>
        </div>
          ...
          <div className="container pb-5 lg:pb-0">
            <div className="text-center lg:mb-12 mb-7">
              <h2 className="snap-block-heading">
                Cách đổi định dạng ảnh bất kỳ trên SnapEdit?
              </h2>
              <div className="text-neutral-ink-600 lg:w-2/3 lg:mx-auto T14R lg:T16R">
                <p>
                  Người dùng dễ dàng thay đổi định dạng hình ảnh thông qua bộ
                  chuyển đổi của SnapEdit. Công cụ tương thích với các thiết bị.
            ...
            <div className="regular slider lg:grid lg:gap-9 lg:grid-cols-3">
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/convert-image/Step_1.webp"
                  alt="Tải ảnh lên"
                ...
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Người dùng tải lên tập tin hình ảnh vào công cụ chuyển của
                    SnapEdit. Công cụ sẽ tự động nhận diện định dạng nguồn.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/convert-image/Step_2.webp"
                  alt="Chọn định dạng đích"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  <h3 className="font-semibold mb-4">
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Chọn định dạng đích bạn muốn chuyển đổi.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/convert-image/Step_3.webp"
                  alt="Chuyển đổi"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Nhấp vào nút Chuyển đổi Ngay. Sau khi hoàn thành, tải xuống
                    hình ảnh ở định dạng mới vào thiết bị của bạn.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl banner-gradient sm:py-10 sm:px-14 sm:flex sm:justify-between sm:items-center px-4 py-6 text-center">
              <div className="mb-4 sm:flex-1">
                ...
                <p className="font-normal text-base-content px-2 sm:w-3/4">
                  ...
                  trên khắp thế giới để cải thiện chất lượng ảnh.
                </p>
              </div>
            ...
            <div className="container">
              ...
              <div className="space-y-12 pt-10 lg:pt-[72px] lg:space-y-16">
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/convert-image/feat_1.webp"
                    alt="Chuyển đổi hình ảnh cho website bằng công cụ chuyển đổi hình ảnh SnapEdit"
                  ...
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Đổi định dạng ảnh phù hợp cho website
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      SnapEdit giúp chuyển đổi ảnh sang các định dạng nén như
                      JPEG hoặc WEBP để giảm kích thước ảnh cũng như cải thiện
                      hiệu suất của trang web. Hãy để SnapEdit tối ưu hóa hình
                      ảnh trên các nền tảng online.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/convert-image/feat_2.webp"
                    alt="Chuyển đổi hình ảnh cho chỉnh sửa ảnh"
                    className="max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pl-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Chuyển định dạng cho chỉnh sửa ảnh
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Công cụ này giúp chuyển đổi hình ảnh sang các định dạng
                      khác nhau để dễ dàng chỉnh sửa và làm việc. Ví dụ: chuyển
                      đổi JPEG sang PNG để dễ dàng xoá nền, chuyển đổi PNG sang
                      PDF để tạo tài liệu hoặc chuyển đổi HEIC sang PNG để chỉnh
                      sửa trong phần mềm chỉnh sửa ảnh khác.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/convert-image/feat_3.webp"
                    alt="Chuyển định dạng để dễ dàng được hỗ trợ"
                    className="order-2 max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Chuyển ảnh sang các định dạng được hỗ trợ rộng rãi
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Công cụ chuyển đổi hình ảnh của SnapEdit giúp lưu trữ các
                      hình ảnh cũ bằng cách chuyển chúng sang các định dạng hiện
                      đại và được hỗ trợ rộng rãi. Điều này làm giảm nguy cơ các
                      định dạng cũ không thể truy cập được hoặc không tương
                      thích.
                    </p>
                  </div>
                </div>
              ...
              <ul className="lg:mb-14 mb-10 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-24 lg:gap-y-8">
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Hỗ trợ chuyển các định dạng ảnh phổ biến"
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Bộ chuyển đổi hình ảnh SnapEdit hỗ trợ bất kỳ định dạng
                      phổ biến bao gồm jpg, png, pdf, tiff, webp. Bạn có thể
                      chuyển đổi JPG sang PNG cho đồ họa logo và hình ảnh với
                      nền trong suốt, chuyển đổi JPG sang TIFF cho in ấn, chuyển
                      đổi WEBP sang PNG cho việc chỉnh sửa chuyên nghiệp, chuyển
                      đổi PNG sang JPG cho việc nén hình ảnh.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Giữ chất lượng và metadata của hình ảnh"
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Giữ chất lượng và metadata
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Chất lượng hình ảnh được giữ nguyên như hình ảnh ban đầu.
                      SnapEdit không làm giảm chất lượng hình ảnh. Ngoài ra,
                      thông tin quan trọng của anh và thông báo bản quyền cũng
                      được giữ lại.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Chuyển đổi hình ảnh một cách nhanh chóng với SnapEdit"
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Xử lý nhanh hơn, an toàn hơn
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Trong khi các công cụ khác tải file lên máy chủ để xử lý
                      chuyển đổi, SnapEdit thực hiện việc đó trực tiếp ở phía
                      máy khách. Vì vậy sẽ không có bất kỳ vấn đề bảo mật nào
                      với hình ảnh của người dùng. Hơn nữa, thời gian xử lý cũng
                      nhanh hơn.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Xử lý hàng loạt cho việc chuyển đổi hình ảnh"
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Đổi format ảnh hàng loạt
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit có thể xử lý tối đa 50 ảnh cùng một lúc. Tải
                      nhiều tệp ảnh lên cùng lúc, chọn định dạng mong muốn và
                      nhấp vào nút chuyển đổi để quá trình được thực hiện nhanh
                      chóng.
                    </p>
                  </div>
                </li>
          ...
          <div className="max-w-[1200px] m-auto tablet:px-10 mobile:px-4 lg:px-0">
            <div className="mb-6 text-center lg:mb-12">
              <h2 className="text-[#212B39] lg:text-[56px] lg:font-bold lg:leading-[72px] text-[32px] font-semibold leading-[44px]">
                Câu hỏi thường gặp về đổi định dạng ảnh trên SnapEdit
              </h2>
            </div>
            <ul className="border-t divide-y">
              <li>
                <button
                  ...
                  id="headlessui-disclosure-button-:red:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Công cụ chuyển đổi của SnapEdit có thay đổi kích thước ảnh
                    không?
                  </h3>
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:ref:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Công cụ chuyển đổi có ảnh hưởng đến chất lượng hình ảnh
                    không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:reh:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    SnapEdit image converter có miễn phí không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rej:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Bộ chuyển đổi định dạng ảnh của SnapEdit có đáng tin cậy
                    không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rel:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Bộ chuyển đổi hình ảnh SnapEdit có đặt watermark lên ảnh của
                    tôi không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:ren:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Làm thế nào để chuyển đổi ảnh trên iPhone?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
