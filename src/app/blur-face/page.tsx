          ...
          <div className="container pt-[90px] space-y-6 lg:relative lg:space-y-0 lg:min-h-[700px] lg:pt-[160px] lg:flex lg:justify-between lg:items-start">
            <div className="lg:pr-4">
              <h1 className="text-neutral-ink-700 mb-4 text-center lg:text-left !leading-tight H30B lg:H56B">
                Làm mờ khuôn mặt trong ảnh online{" "}
              ...
              <p className="text-neutral-ink-600 text-center lg:text-left T16R lg:T20R">
                Công cụ{" "}
                <a href="https://snapedit.app/vi/blur-face">
                  {" "}
                  SnapEdit làm mờ khuôn mặt
                </a>{" "}
                trong ảnh giúp ẩn danh an toàn và nhanh chóng.
              </p>
              <div className="mt-4 sm:block hidden">
                <img
                  src="https://assets.snapedit.app/images/blur-face/hero_banner_static.webp"
                  alt="Làm mờ khuôn mặt trong ảnh"
                />
              </div>
            </div>
                    ...
                    <ul className="space-x-3">
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/blur-face/demo-thumbnail-1.jpg"
                            alt="sample"
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/blur-face/demo-thumbnail-2.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/blur-face/demo-thumbnail-3.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/blur-face/demo-thumbnail-4.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
          ...
          <div className="container pb-5 lg:pb-0">
            <div className="text-center lg:mb-12 mb-7">
              <h2 className="snap-block-heading">
                Cách làm mờ khuôn mặt trong ảnh tự động trên SnapEdit?
              </h2>
              <div className="text-neutral-ink-600 lg:w-2/3 lg:mx-auto T14R lg:T16R">
                <p>
                  Dù bạn muốn bảo vệ quyền riêng tư hay tuân thủ các quy định
                  khi đăng ảnh lên mạng xã hội, hãy để công cụ làm mờ khuôn mặt
                  online của chúng tôi giúp bạn.{" "}
                </p>
              </div>
            </div>
            <div className="regular slider lg:grid lg:gap-9 lg:grid-cols-3">
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/blur-face/step-1.webp"
                  alt="Tải ảnh lên"
                ...
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Tải ảnh của bạn lên trình chỉnh sửa làm mờ khuôn mặt. Sau
                    khi tải xong, hệ thống sẽ tự động nhận diện và làm mờ khuôn
                    mặt.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/blur-face/step-2.webp"
                  alt="Điều chỉnh hiệu ứng làm mờ"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  <h3 className="font-semibold mb-4">
                    ...
                    <span className="font-semibold text-[14px] leading-[18px] align-middle inline-block">
                      Điều chỉnh hiệu ứng làm mờ
                    </span>
                  </h3>
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Chọn loại hiệu ứng làm mờ mà chúng tôi cung cấp: làm mờ cổ
                    điển hoặc làm mờ pixel. Điều chỉnh cường độ làm mờ theo ý
                    thích của bạn.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/blur-face/step-3.webp"
                  alt="Tải ảnh xuống"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Xem trước và tải ảnh mới về thiết bị của bạn.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#F8FAFD] lg:pt-24 lg:pb-[120px] py-12">
            <div className="container">
              <h2 className="leading-normal lg:w-3/4 H30B lg:H56B">
                Làm mờ khuôn mặt để bảo vệ quyền riêng tư trong nhiều tình huống{" "}
              ...
              <div className="space-y-12 pt-10 lg:pt-[72px] lg:space-y-16">
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/blur-face/frame-1.webp"
                    alt="Dùng ảnh làm mờ khuôn mặt để tránh bị nhận diện"
                  ...
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Tránh nhận diện khuôn mặt
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      <a href="https://snapedit.app/vi/blur-face">
                        Làm mờ khuôn mặt
                      </a>{" "}
                      để ẩn danh khi chia sẻ ảnh lên mạng. Bảo vệ bản thân và
                      người khác khỏi công nghệ nhận diện khuôn mặt và AI.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/blur-face/frame-2.webp"
                    alt="Làm mờ khuôn mặt để tuân thủ luật riêng tư"
                    className="max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pl-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Tuân thủ luật bảo vệ quyền riêng tư
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Công cụ làm mờ khuôn mặt giúp ảnh của bạn tuân thủ các
                      luật bảo vệ quyền riêng tư (ví dụ: GDPR) và các quy định
                      đạo đức khi đăng ảnh công khai trên báo chí hoặc trên mạng
                      xã hội.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/blur-face/frame-3.webp"
                    alt="Làm mờ khuôn mặt trong nội dung nhạy cảm"
                    className="order-2 max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                    ...
                    <p className="sm:mb-8 mb-4 text-sm">
                      Làm mờ khuôn mặt trên ảnh của nạn nhân tội phạm, trẻ vị
                      thành niên hoặc nhân chứng để bảo vệ danh tính và tuân thủ
              ...
              <ul className="lg:mb-14 mb-10 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-24 lg:gap-y-8">
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Sử dụng công nghệ nhận diện khuôn mặt AI, SnapEdit tự động nhận diện và làm mờ khuôn mặt chính xác mà không cần chọn thủ công."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Làm mờ khuôn mặt tự động
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Sử dụng công nghệ nhận diện khuôn mặt AI, SnapEdit tự động
                      nhận diện và làm mờ khuôn mặt chính xác mà không cần chọn
                      thủ công.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="SnapEdit cung cấp hai hiệu ứng làm mờ chính là: cổ điển và làm mờ pixel. Chọn kiểu bạn thích và điều chỉnh mức độ làm mờ."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Nhiều lựa chọn hiệu ứng làm mờ
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit cung cấp hai hiệu ứng làm mờ chính là: cổ điển và
                      làm mờ pixel. Chọn kiểu bạn thích và điều chỉnh mức độ làm
                      mờ.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Làm mờ khuôn mặt trong ảnh nhanh chóng với SnapEdit mà không cần nhận diện thủ công. Công cụ đơn giản, dễ sử dụng cho tất cả mọi người."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Xử lý làm mờ nhanh chóng
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Làm mờ khuôn mặt trong ảnh nhanh chóng với SnapEdit mà
                      không cần nhận diện thủ công. Công cụ đơn giản, dễ sử dụng
                ...
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Ảnh của bạn được xử lý an toàn và tự động xóa sau 60 phút. SnapEdit không lưu trữ hoặc chia sẻ ảnh của bạn."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Ảnh của bạn được xử lý an toàn và tự động xóa sau 60 phút.
                      SnapEdit không lưu trữ hoặc chia sẻ ảnh của bạn.
                    </p>
                  </div>
                </li>
              </ul>
          ...
          <div className="max-w-[1200px] m-auto tablet:px-10 mobile:px-4 lg:px-0">
            <div className="mb-6 text-center lg:mb-12">
              <h2 className="text-[#212B39] lg:text-[56px] lg:font-bold lg:leading-[72px] text-[32px] font-semibold leading-[44px]">
                Các câu hỏi thường gặp về làm mờ khuôn mặt
              </h2>
            </div>
            <ul className="border-t divide-y">
              <li>
                <button
                  ...
                  id="headlessui-disclosure-button-:rkc:"
                  type="button"
                  aria-expanded="false"
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rke:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    SnapEdit sử dụng hiệu ứng làm mờ khuôn mặt nào?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rkg:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Sự khác biệt giữa hiệu ứng Pixelate và Gaussian Blur là gì?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rki:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Công cụ này có làm mờ nhiều khuôn mặt trong ảnh không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rkk:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể hoàn tác hiệu ứng sau khi làm mờ khuôn mặt không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rkm:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể làm mờ nhiều ảnh cùng lúc không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rko:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể làm mờ đối tượng khác trong ảnh trên SnapEdit
                    không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rkq:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Làm mờ khuôn mặt trên SnapEdit có miễn phí không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
