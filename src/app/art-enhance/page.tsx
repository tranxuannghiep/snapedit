...
export default function AirEnhance() {
  return (
          ...
          <div className="container pt-[90px] space-y-6 lg:relative lg:space-y-0 lg:min-h-[700px] lg:pt-[160px] lg:flex lg:justify-between lg:items-start">
            <div className="lg:pr-4">
              <h1 className="text-neutral-ink-700 mb-4 text-center lg:text-left !leading-tight H30B lg:H56B">
                Làm nét ảnh nghệ thuật lên đến 4X{" "}
              ...
              <p className="text-neutral-ink-600 text-center lg:text-left T16R lg:T20R">
                Làm nét ảnh anime, manga, ảnh hoạt hình, ảnh gen bằng AI chỉ với
                1 cú nhấp chuột. Cải thiện chúng sắc nét hơn.
              </p>
              <div className="mt-4 sm:block hidden">
                <img src="https://assets.snapedit.app/images/art-enhance/hero_banner_static.webp" />
              </div>
            </div>
                    ...
                    <ul className="space-x-3">
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/art-enhance/art-enhance-demo-1.jpeg"
                            alt="sample"
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/art-enhance/art-enhance-demo-2.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/art-enhance/art-enhance-demo-3.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/art-enhance/art-enhance-demo-4.jpeg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
          ...
          <div className="container pb-5 lg:pb-0">
            <div className="text-center lg:mb-12 mb-7">
              <h2 className="snap-block-heading">
                Cách sử dụng công cụ SnapEdit art upscaler?
              </h2>
            ...
            <div className="regular slider lg:grid lg:gap-9 lg:grid-cols-3">
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/art-enhance/Step_1.webp"
                ...
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Nhấp vào nút TẢI ẢNH lên hoặc kéo và thả bất kỳ hình ảnh
                    anime hoặc ảnh nghệ thuật mà bạn muốn cải thiện.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/art-enhance/Step_2.webp"
                  alt="AI tự động làm nét ảnh"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  <h3 className="font-semibold mb-4">
                    ...
                    <span className="font-semibold text-[14px] leading-[18px] align-middle inline-block">
                      AI tự động làm nét ảnh
                    </span>
                  </h3>
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    SnapEdit sẽ tự động tăng chất lượng của hình ảnh hình hoạ,
                    ảnh vẽ trong 1-3 giây. So sánh trực quan kết quả trước và
                    sau trên màn hình của bạn.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/art-enhance/Step_3.webp"
                  alt="Lưu và chia sẻ"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Tải xuống hình ảnh mới ở định dạng HD về điện thoại/PC của
                    bạn và chia sẻ nó với những người khác.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl banner-gradient sm:py-10 sm:px-14 sm:flex sm:justify-between sm:items-center px-4 py-6 text-center">
              <div className="mb-4 sm:flex-1">
                ...
                <p className="font-normal text-base-content px-2 sm:w-3/4">
                  ...
                  trên khắp thế giới để cải thiện chất lượng hình ảnh.
                </p>
              </div>
            ...
            <div className="container">
              ...
              <div className="space-y-12 pt-10 lg:pt-[72px] lg:space-y-16">
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/art-enhance/feat_1.webp"
                    alt="Hình ảnh anime được cải thiện bởi SnapEdit AI art enhancer"
                  ...
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Biến ảnh nghệ thuật bị mờ thành ảnh HD sắc nét
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Công cụ AI của SnapEdit cải thiện độ phân giải, độ sắc nét
                      cho bất kỳ hình ảnh mờ nào. Nó làm sắc nét màu sắc, tăng
                      số pixel để làm cho hình ảnh trở nên hấp dẫn hơn về mặt
                      thị giác ở chất lượng HD. Sẵn sàng cho việc xem tốt hơn
                      trên các thiết bị hiện đại và màn hình lớn hơn.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/art-enhance/feat_2.webp"
                    alt="Cải thiện hình ảnh, tranh vẽ tự tạo của fan"
                    className="max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pl-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Tạo ra các fanart anime tuyệt đẹp
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Nhiều ảnh tự làm của fan và ảnh gen bằng AI có chất lượng
                      thấp. Đưa chúng vào trong SnapEdit AI anime enhancer để
                      làm cho chúng trở nên tuyệt đẹp hơn. Làm sắc nét những chi
                      tiết này và khôi phục sự phong phú ban đầu của tác phẩm
                      nghệ thuật.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/art-enhance/feat_3.webp"
                    alt="Khôi phục và bảo tồn những bức ảnh nghệ thuật cũ"
                    className="order-2 max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Khôi phục ảnh anime, ảnh hoạt hình cũ
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      AI anime upscaler có thể giảm noise của các hình ảnh anime
                      cũ trong vài giây, biến chúng thành các tác phẩm nghệ
                      thuật thực tế để dùng làm hình nền, nhãn dán, album và
                      video hoạt hình.
                    </p>
                  </div>
                </div>
            ...
            <div className="container">
              <ul className="lg:mb-14 mb-10 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-24 lg:gap-y-8">
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    src="https://assets.snapedit.app/images/enhance/Frame_1.png"
                    alt="Làm nét ảnh nghệ thuật bằng AI"
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Làm nét ảnh nghệ thuật nhanh hơn bằng AI
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit sử dụng AI để cải thiện chất lượng của hình ảnh
                      hoạt hình, ảnh gen bằng AI và anime, manga một cách hiệu
                      quả. Nó tự động tăng độ phân giải, làm sắc nét hình ảnh và
                      giảm noise từ các hình ảnh cũ. SnapEdit làm cho việc biến
                      hình ảnh anime thành tác phẩm nghệ thuật truyền cảm hứng
                      trở nên dễ dàng hơn với các fan.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    src="https://assets.snapedit.app/images/enhance/Frame_2.png"
                    alt="Dễ dàng nâng cao chất lượng ảnh trên tất cả các thiết bị"
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Dễ dàng sử dụng trên tất cả các thiết bị
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Khả năng truy cập trực tuyến của SnapEdit cho phép người
                      dùng chỉnh sửa hình ảnh trên bất kỳ thiết bị nào. Cho dù
                      bạn đang sử dụng điện thoại di động hoặc PC, iOS hoặc
                      Android, chỉ cần truy cập trang web SnapEdit để bắt đầu.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    src="https://assets.snapedit.app/images/enhance/Frame_3.png"
                    alt="Miễn phí để nâng cao chất lượng ảnh anime"
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Miễn phí chỉnh sửa đến 3 hình ảnh anime mỗi ngày. Nếu bạn
                      ưa thích SnapEdit, hãy trở thành người đăng ký để truy cập
                      vào các công cụ đầy đủ. Nhận xử lý video và chỉnh sửa hình
                      ảnh mà không có giới hạn.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    src="https://assets.snapedit.app/images/enhance/Frame_4.png"
                    alt="Chỉnh sửa ảnh nghệ thuật với nhiều tính năng hơn"
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Chỉnh sửa ảnh nghệ thuật với đa tính năng
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Sau khi làm nét ảnh anime bằng AI, bạn có thể tiếp tục sử
                      dụng các công cụ AI khác trên SnapEdit bao gồm loại bỏ
                      nền, làm sáng hình ảnh, loại bỏ văn bản, vv. Tất cả đều
                      được thực hiện tự động với công nghệ AI tiên tiến.
                    </p>
                  </div>
                </li>
              </ul>
          ...
          <div className="max-w-[1200px] m-auto tablet:px-10 mobile:px-4 lg:px-0">
            <div className="mb-6 text-center lg:mb-12">
              <h2 className="text-[#212B39] lg:text-[56px] lg:font-bold lg:leading-[72px] text-[32px] font-semibold leading-[44px]">
                Câu hỏi thường gặp liên quan đến công cụ làm nét ảnh nghệ thuật
                SnapEdit
              </h2>
            </div>
            <ul className="border-t divide-y">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rcq:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Công cụ SnapEdit anime upscaler hoạt động như thế nào?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rcs:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Có thể làm nét hình ảnh anime 1080p không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rcu:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Làm cách nào để làm nét hình ảnh nghệ thuật?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rd0:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể cải thiện hình ảnh anime trên các thiết bị
                    iPhone/Android được không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rd2:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Làm nét ảnh nghệ thuật có miễn phí không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
