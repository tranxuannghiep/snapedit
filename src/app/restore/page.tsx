            ...
            <div className="lg:pr-4">
              <h1 className="text-neutral-ink-700 mb-4 text-center lg:text-left !leading-tight H30B lg:H56B">
                ...
                <div className="block w-fit relative after:absolute after:bg-[#27FFFF] after:left-0 after:bottom-1.5 lg:after:bottom-2 after:w-full after:h-2 lg:after:h-3 mx-auto mt-2 lg:mx-0 lg:mt-0">
                  <span className="relative z-10">trong 1 cú nhấp chuột</span>
                </div>
              </h1>
              <p className="text-neutral-ink-600 text-center lg:text-left T16R lg:T20R">
                Thổi sức sống mới vào những hình ảnh cũ bằng tính năng khôi phục
                ảnh một chạm mới của SnapEdit!
              </p>
              <div className="mt-4 sm:block hidden">
                <img src="https://assets.snapedit.app/images/restore/hero_banner_static.webp" />
              </div>
            </div>
                    ...
                    <ul className="space-x-3">
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/restore/restore_demo_1.jpg"
                            alt="sample"
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/restore/restore_demo_2.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/restore/restore_demo_3.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
          ...
          <div className="container pb-5 lg:pb-0">
            <div className="text-center lg:mb-12 mb-7">
              <h2 className="snap-block-heading">
                Cách khôi phục ảnh cũ bằng SnapEdit
              </h2>
            ...
            <div className="regular slider lg:grid lg:gap-9 lg:grid-cols-3">
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/restore/step_1.png"
                ...
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Nhấp vào Tải lên hình ảnh hoặc kéo và thả ảnh bạn muốn vào
                    phần Tải lên.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/restore/step_2.png"
                  alt="So sánh trước & sau"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  <h3 className="font-semibold mb-4">
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Trong vài giây, SnapEdit sẽ tạo ra một phiên bản ảnh cũ đã
                    được khôi phục, giống như mới của bạn.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/restore/step_3.png"
                  alt="Chia sẻ (hoặc tạo video)!"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  <h3 className="font-semibold mb-4">
                    ...
                    <span className="font-semibold text-[14px] leading-[18px] align-middle inline-block">
                      Chia sẻ (hoặc tạo video)!
                    </span>
                  </h3>
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Bạn có thể dễ dàng tạo video thể hiện quá trình chuyển đổi
                    hoặc đơn giản là chia sẻ kết quả với những người thân yêu
                    của mình.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-[#F8FAFD] lg:pt-24 lg:pb-[120px] py-12">
            <div className="container">
              <h2 className="leading-normal lg:w-3/4 H30B lg:H56B">
                Phục hồi ảnh bằng một cú nhấp chuột với{" "}
                <span className="inline-block leading-normal ai-gradient">
                  Trí tuệ nhân tạo của SnapEdit
                </span>
              </h2>
              <div className="space-y-12 pt-10 lg:pt-[72px] lg:space-y-16">
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/restore/feature_1.png"
                    alt="Làm sắc nét chi tiết ảnh cũ"
                  ...
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Làm sắc nét hình ảnh cũ
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Khám phá các chi tiết mờ trên ảnh cũ của bạn. Hãy nhìn vào
                      nụ cười đó!
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/restore/feature_2.png"
                    alt="Khôi phục màu sắc và chi tiết ảnh"
                    className="max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pl-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Khôi phục các chi tiết và màu sắc bị thiếu
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Sơn lại và đổ đầy màu sắc và chi tiết trên hình ảnh trong
                      tích tắc.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/restore/feature_3.png"
                    alt="Phục hồi một chạm với SnapEdit"
                    className="order-2 max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                    ...
                    <p className="sm:mb-8 mb-4 text-sm">
                      Đơn giản và dễ sử dụng. Sau khi tải lên, SnapEdit sẽ thực
                      hiện phần còn lại.
                    </p>
                  </div>
                </div>
              ...
              <ul className="lg:mb-14 mb-10 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-24 lg:gap-y-8">
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="SnapEdit được sử dụng miễn phí với các tùy chọn để nâng cấp lên người dùng chuyên nghiệp. Người dùng miễn phí vẫn có thể truy cập tất cả các tính năng của chúng tôi."
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit được sử dụng miễn phí với các tùy chọn để nâng
                      cấp lên người dùng chuyên nghiệp. Người dùng miễn phí vẫn
                      có thể truy cập tất cả các tính năng của chúng tôi.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="SnapEdit tự động khôi phục ảnh cũ sau khi tải lên. Không có bước thứ hai."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit tự động khôi phục ảnh cũ sau khi tải lên. Không
                      có bước thứ hai.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Người dùng trên điện thoại di động có thể tải xuống ứng dụng của chúng tôi trên các cửa hàng iOS và Android trong khi người dùng PC có thể sử dụng hầu hết các trình duyệt để truy cập SnapEdit. Sửa chữa và nâng cấp ảnh cũ ở nơi bạn chọn."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Trực tuyến &amp; Trên tất cả các thiết bị
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Người dùng trên điện thoại di động có thể tải xuống ứng
                      dụng của chúng tôi trên các cửa hàng iOS và Android trong
                      khi người dùng PC có thể sử dụng hầu hết các trình duyệt
                      để truy cập SnapEdit. Sửa chữa và nâng cấp ảnh cũ ở nơi
                      bạn chọn.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Không còn phải loay hoay với các nút mà bạn không hiểu trong PTS. Khôi phục ảnh cũ sẽ dễ dàng hơn - và có kết quả tốt hơn."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Tiết kiệm thời gian và cải thiện chất lượng
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Không còn phải loay hoay với các nút mà bạn không hiểu
                      trong PTS. Khôi phục ảnh cũ sẽ dễ dàng hơn - và có kết quả
                      tốt hơn.
                    </p>
                  </div>
                </li>
          ...
          <div className="max-w-[1200px] m-auto tablet:px-10 mobile:px-4 lg:px-0">
            <div className="mb-6 text-center lg:mb-12">
              <h2 className="text-[#212B39] lg:text-[56px] lg:font-bold lg:leading-[72px] text-[32px] font-semibold leading-[44px]">
                Câu hỏi thường gặp về tính năng Phục hồi ảnh
              </h2>
            </div>
            <ul className="border-t divide-y">
              <li>
                <button
                  ...
                  id="headlessui-disclosure-button-:rtj:"
                  type="button"
                  aria-expanded="false"
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rtl:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rtn:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Làm cách nào để khôi phục kỹ thuật số ảnh cũ?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rtp:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tất cả ảnh có thể được khôi phục không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rtr:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rtt:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể sử dụng tính năng khôi phục ảnh SnapEdit trên
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rtv:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Phục chế ảnh cũ có miễn phí không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
