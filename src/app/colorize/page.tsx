          ...
          <div className="container pt-[90px] space-y-6 lg:relative lg:space-y-0 lg:min-h-[700px] lg:pt-[160px] lg:flex lg:justify-between lg:items-start">
            <div className="lg:pr-4">
              <h1 className="text-neutral-ink-700 mb-4 text-center lg:text-left !leading-tight H30B lg:H56B">
                Tô màu ảnh trực tuyến miễn phí{" "}
              ...
              <div className="mt-4 sm:block hidden">
                <img src="https://assets.snapedit.app/images/colorize/hero_banner_static.webp" />
              </div>
            </div>
                    ...
                    <ul className="space-x-3">
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/colorize/demo1_xs.jpg"
                            alt="sample"
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/colorize/demo2_xs.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/colorize/demo3_xs.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/colorize/demo4_xs.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
          ...
          <div className="container pb-5 lg:pb-0">
            <div className="text-center lg:mb-12 mb-7">
              <h2 className="snap-block-heading">
                Cách sử dụng công cụ tô màu ảnh AI SnapEdit?
              </h2>
            ...
            <div className="regular slider lg:grid lg:gap-9 lg:grid-cols-3">
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/colorize/step_1.webp"
                  alt="Tải lên ảnh"
                ...
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Nhấp vào nút tải lên hoặc kéo và thả một bức ảnh đen trắng
                    vào công cụ.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/colorize/step_2.webp"
                  alt="Thay đổi màu của ảnh"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  <h3 className="font-semibold mb-4">
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Hệ thống AI bắt đầu phân tích, xác định các đặc điểm của
                    ảnh, dự đoán màu sắc có thể có cho mỗi pixel rồi tự động tô
                    màu.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/colorize/step_3.webp"
                  alt="Tải về"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Nếu hài lòng với kết quả, hãy lưu ảnh về máy với chất lượng
                    HD. Chỉ cần nhấp vào nút tải về.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#F8FAFD] lg:pt-24 lg:pb-[120px] py-12">
            <div className="container">
              <h2 className="leading-normal lg:w-3/4 H30B lg:H56B">
                Tô màu và khôi phục những tấm hình đen trắng cũ với AI{" "}
              ...
              <div className="space-y-12 pt-10 lg:pt-[72px] lg:space-y-16">
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/colorize/uc1.webp"
                    alt="Tăng cường sức hấp dẫn của hình ảnh"
                  ...
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Tăng sức hấp dẫn cho ảnh
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Khôi phục màu cho ảnh đen trắng là một trải nghiệm thú vị.
                      Với màu sắc sống động, bạn sẽ thấy rõ các gương mặt, trang
                      phục và môi trường xung quanh.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/colorize/uc2.webp"
                    alt="Bảo tồn ảnh cũ"
                  ...
                  <div className="sm:pl-20 mt-4">
                    ...
                    <p className="sm:mb-8 mb-4 text-sm">
                      ...
                      lưu giữ những tấm ảnh kỷ niệm cho các thế hệ sau.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/colorize/uc3.webp"
                    alt="Hiểu hơn lịch qua ảnh phục chế"
                    className="order-2 max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Phục chế ảnh lịch sử
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Công cụ tô màu ảnh đen trắng của SnapEdit rất hữu ích cho
                      những ai đam mê phục chế màu cho ảnh lịch sử. Qua những
                      hình ảnh được phục chế màu, người xem có thể tưởng tượng
                      và hiểu rõ bối cảnh lịch sử thời bấy giờ.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <ul className="lg:mb-14 mb-10 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-24 lg:gap-y-8">
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Thông qua hàng nghìn lượt huấn luyện, SnapEdit AI có thể dự đoán và áp dụng các màu sắc phù hợp với ngữ cảnh và phong cách của hình ảnh gốc một cách chính xác."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Tô màu ảnh chính xác
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Thông qua hàng nghìn lượt huấn luyện, SnapEdit AI có thể
                      dự đoán và áp dụng các màu sắc phù hợp với ngữ cảnh và
                      phong cách của hình ảnh gốc một cách chính xác.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Công cụ tô màu mang đến những hình ảnh hài lòng ngay từ lần đầu tiên với vẻ ngoài chân thực, tự nhiên. Tải xuống ảnh ở định dạng HD."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Trả ảnh chất lượng cao
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Công cụ tô màu mang đến những hình ảnh hài lòng ngay từ
                      lần đầu tiên với vẻ ngoài chân thực, tự nhiên. Tải xuống
                      ảnh ở định dạng HD.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="AI thực hiện tô màu ảnh nhanh chóng. Toàn bộ quá trình được tự động hóa chỉ trong vài giây, đặc biệt là cho các hình ảnh có độ phân giải cao."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Phục chế ảnh AI nhanh chóng
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      AI thực hiện tô màu ảnh nhanh chóng. Toàn bộ quá trình
                      được tự động hóa chỉ trong vài giây, đặc biệt là cho các
                ...
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Công cụ có thể được sử dụng trực tuyến một cách thuận tiện trên bất kỳ thiết bị nào, di động iOS, Android, PC hoặc Laptop. Chỉ cần mở trang web và chọn tô màu ảnh."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Công cụ có thể được sử dụng trực tuyến một cách thuận tiện
                      trên bất kỳ thiết bị nào, di động iOS, Android, PC hoặc
                      Laptop. Chỉ cần mở trang web và chọn tô màu ảnh.
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <ul className="border-t divide-y">
              <li>
                <button
                  ...
                  id="headlessui-disclosure-button-:ric:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể tô màu một bức ảnh đã có màu sẵn không?
                  </h3>
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rie:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Việc tô màu có ảnh hưởng đến chất lượng ảnh gốc không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rig:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể điều chỉnh màu sắc sau khi ảnh được tô màu không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rii:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể điều chỉnh độ bão hòa màu hoặc độ sáng không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rik:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    SnapEdit sử dụng công nghệ AI gì để tô màu?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rim:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể lưu ảnh đã tô màu dưới định dạng khác (ví dụ:
                    JPEG, PNG) không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rio:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Việc sử dụng công cụ tô màu của SnapEdit có ảnh hưởng đến dữ
                    liệu của ảnh không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:riq:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể tô màu ảnh miễn phí không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
