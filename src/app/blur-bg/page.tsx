          ...
          <div className="container pt-[90px] space-y-6 lg:relative lg:space-y-0 lg:min-h-[700px] lg:pt-[160px] lg:flex lg:justify-between lg:items-start">
            <div className="lg:pr-4">
              ...
              <p className="text-neutral-ink-600 text-center lg:text-left T16R lg:T20R">
                Biến hoá hình ảnh ngay lập tức với công cụ{" "}
                <a href="https://snapedit.app/vi/blur-bg">làm mờ nền ảnh</a> của
                SnapEdit. Thử miễn phí!
              </p>
              <div className="mt-4 sm:block hidden">
                <img
                  src="https://assets.snapedit.app/images/blur-bg/hero_banner_static.webp"
                  alt="Công cụ làm mờ nền online"
                />
              </div>
            </div>
          ...
          <div className="container pb-5 lg:pb-0">
            <div className="text-center lg:mb-12 mb-7">
              <h2 className="snap-block-heading">
                {" "}
                Cách làm mờ nền ảnh online
              </h2>
              <div className="text-neutral-ink-600 lg:w-2/3 lg:mx-auto T14R lg:T16R">
                <p>
                  Không cần học cài đặt các thông số phức tạp về khẩu độ và ống
                  kính ở máy ảnh; công cụ của chúng tôi giúp bạn có ảnh với nền
                  mờ ảo và làm nổi bật đối tượng chủ thể chỉ với vài cú nhấp
                  chuột.{" "}
                </p>
              </div>
            </div>
            <div className="regular slider lg:grid lg:gap-9 lg:grid-cols-3">
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/blur-bg/Step_1.webp"
                  alt="Tải ảnh lên"
                ...
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Tải lên hoặc kéo thả ảnh vào công cụ làm mờ nền
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/blur-bg/Step_2.webp"
                  alt=" Làm mờ nền với hiệu ứng AI"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  <h3 className="font-semibold mb-4">
                    ...
                    <span className="font-semibold text-[14px] leading-[18px] align-middle inline-block">
                      {" "}
                      Làm mờ nền với hiệu ứng AI
                    </span>
                  </h3>
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Sau khi tải ảnh lên, công cụ sẽ tự động làm mờ phông nền với
                    mức mặc định là 20. Trong bước này, bạn có thể chọn hiệu ứng
                    và điều chỉnh mức độ làm mờ theo ý thích.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/blur-bg/Step_3.webp"
                  alt=" Lưu ảnh về máy"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Tải ảnh mới của bạn với nền đã được làm mờ.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="container">
              ...
              <div className="space-y-12 pt-10 lg:pt-[72px] lg:space-y-16">
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/blur-bg/Frame_1.webp"
                    alt="Công cụ làm mờ phông nền tạo chiều sâu cho ảnh chân dung"
                  ...
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Thêm chiều sâu cho ảnh chân dung
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Sau khi được làm mờ nền, ảnh chân dung trở nên có chiều
                      sâu hơn, thu hút sự chú ý vào các đặc điểm trên khuôn mặt
                      người được chụp ảnh.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/blur-bg/Frame_2.webp"
                    alt="Làm nổi bật ảnh thương mại điện tử"
                    className="max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pl-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Làm nổi bật ảnh sản phẩm
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Tương tự như ảnh chân dung, công cụ giúp làm mờ nền giúp
                      tập trung sự chú ý vào sản phẩm. Nó làm nổi bật các đặc
                      điểm chính và tạo ra những hình ảnh thương mại điện tử hấp
                      dẫn thúc đẩy doanh số.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/blur-bg/Frame_3.webp"
                    alt="Làm nổi bật các yếu tố trong ảnh"
                    className="order-2 max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Tách biệt các yếu tố cụ thể trong cảnh
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Công cụ cũng giúp cho các nhiếp ảnh gia muốn thu hút sự
                      chú ý vào các yếu tố cụ thể trong ảnh bằng cách làm mờ mọi
                      thứ khác xung quanh. Từ đó mà những ảnh chụp cảnh vật cũng
                      trở nên hấp dẫn hơn.
                    </p>
                  </div>
                </div>
              ...
              <ul className="lg:mb-14 mb-10 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-24 lg:gap-y-8">
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Công cụ tự động xác định chủ thể của ảnh chính xác, tạo hiệu ứng làm mờ mượt mà, tự nhiên. So với các công cụ khác, nó mang đến kết quả tốt hơn với đường viền không lem, sắc nét."
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Công cụ tự động xác định chủ thể của ảnh chính xác, tạo
                      hiệu ứng làm mờ mượt mà, tự nhiên. So với các công cụ
                      khác, nó mang đến kết quả tốt hơn với đường viền không
                      lem, sắc nét.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="SnapEdit có 5 hiệu ứng làm mờ ảnh: cổ điển, pixelate, chuyển động, radial, và zoom. Bạn có thể tạo nền bokeh với ánh sáng mờ ảo đẹp mắt."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit có 5 hiệu ứng làm mờ ảnh: cổ điển, pixelate,
                      chuyển động, radial, và zoom. Bạn có thể tạo nền bokeh với
                      ánh sáng mờ ảo đẹp mắt.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Thêm vào đó, bạn có thể tải xuống hình ảnh đã cải thiện với chất lượng HD."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Thêm vào đó, bạn có thể tải xuống hình ảnh đã cải thiện
                      với chất lượng HD.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Không cần cài đặt ứng dụng, bạn có thể sử dụng công cụ này trên điện thoại iPhone, Samsung, máy tính bảng hoặc PC."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Làm mờ nền trực tuyến
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Không cần cài đặt ứng dụng, bạn có thể sử dụng công cụ này
                      trên điện thoại iPhone, Samsung, máy tính bảng hoặc PC.
                    </p>
                  </div>
                </li>
              </ul>
          ...
          <div className="max-w-[1200px] m-auto tablet:px-10 mobile:px-4 lg:px-0">
            ...
            <ul className="border-t divide-y">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rgk:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Đối tượng cũng bị làm mờ, tôi phải làm gì?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rgm:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể làm mờ nền ảnh iPhone không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rgo:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Công cụ của bạn hỗ trợ định dạng nào?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rgq:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Chức năng làm mờ hoạt động như thế nào?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rgs:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Có giới hạn số lượng ảnh tôi có thể chỉnh sửa không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rgu:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Nền làm mờ có ảnh hưởng đến chất lượng ảnh không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rh0:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể lưu ảnh gốc sau khi làm mờ không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
