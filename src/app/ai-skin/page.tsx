...
export default function AiSkin() {
  return (
          ...
          <div className="container pt-[90px] space-y-6 lg:relative lg:space-y-0 lg:min-h-[700px] lg:pt-[160px] lg:flex lg:justify-between lg:items-start">
            <div className="lg:pr-4">
              ...
              <p className="text-neutral-ink-600 text-center lg:text-left T16R lg:T20R">
                Xóa mụn, vết thâm và tàn nhang chỉ với một lần chạm để có bức
                ảnh selfie, chân dung hoàn hảo.
              </p>
              <div className="mt-4 sm:block hidden">
                <img
                  src="https://assets.snapedit.app/images/ai-skin/banner.webp"
                  alt="hero.h1.alt"
                />
              </div>
            </div>
                    ...
                    <ul className="space-x-3">
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/ai-skin/sample_xs_1.webp"
                            alt="sample"
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/ai-skin/sample_xs_2.webp"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/ai-skin/sample_xs_3.webp"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/ai-skin/sample_xs_4.webp"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
          ...
          <div className="container pb-5 lg:pb-0">
            <div className="text-center lg:mb-12 mb-7">
              <h2 className="snap-block-heading">
                Cách Xóa Mụn Trên Ảnh Với AI Skin
              </h2>
              <div className="text-neutral-ink-600 lg:w-2/3 lg:mx-auto T14R lg:T16R">
                <p>
                  ...
                  <a
                    ...
                    href="https://snapedit.app/vi/ai-skin"
                  >
                    AI xóa mụn cho ảnh
                  </a>
                  , làm đều da mặt, chỉnh tông da chỉ trong vài bước đơn giản.{" "}
                </p>
              </div>
            </div>
            <div className="regular slider lg:grid lg:gap-9 lg:grid-cols-3">
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/ai-skin/step_1.webp"
                  alt="Tải ảnh lên"
                ...
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Kéo và thả hoặc nhấn để tải lên ảnh bạn muốn chỉnh sửa. Ảnh
                    nên có ánh sáng tốt và khuôn mặt rõ nét để AI hoạt động hiệu
                    quả.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/ai-skin/step_2.webp"
                  alt="AI chỉnh sửa da"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    AI tự động nhận diện và xóa mụn, xóa khuyết điểm, làm đều
                    vùng da mặt và làm cho da tự nhiên nhất có thể.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/ai-skin/step_3.webp"
                  alt="Tinh chỉnh và tải xuống"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  <h3 className="font-semibold mb-4">
                    ...
                    <span className="font-semibold text-[14px] leading-[18px] align-middle inline-block">
                      Tinh chỉnh và tải xuống
                    </span>
                  </h3>
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Điều chỉnh cường độ và tông trắng của da, sau đó tải ảnh về
                    thiết bị của bạn.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-2xl banner-gradient sm:py-10 sm:px-14 sm:flex sm:justify-between sm:items-center px-4 py-6 text-center">
              <div className="mb-4 sm:flex-1">
                <h2 className="font-semibold text-gray-2 mb-2 sm:text-3xl text-xl">
                  Tải Ứng Dụng SnapEdit
                </h2>
                <p className="font-normal text-base-content px-2 sm:w-3/4">
                  Ứng dụng SnapEdit hiện có trên Apple Store và Google Play
                  Store. Ứng dụng của chúng tôi đã được người dùng trên toàn thế
          ...
          <div className="bg-[#F8FAFD] lg:pt-24 lg:pb-[120px] py-12">
            <div className="container">
              <h2 className="leading-normal lg:w-3/4 H30B lg:H56B">
                Công Cụ Làm Đẹp Da Trên Ảnh Hoàn Hảo Với{" "}
              ...
              <div className="space-y-12 pt-10 lg:pt-[72px] lg:space-y-16">
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/ai-skin/uc_1.webp"
                    alt="Xóa mụn ảnh chỉ trong vài giây"
                  ...
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Làm da đẹp trong ảnh chỉ trong vài giây
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Với AI Skin, bạn không cần phải thành thạo kỹ năng
                      Photoshop phức tạp. Chỉ cần tải ảnh lên công cụ AI Skin và
                      xem AI chỉnh sửa da trong tích tắc. Một giải pháp hoàn hảo
                      cho các bạn nữ và nhiếp ảnh gia muốn tiết kiệm thời gian
                      chỉnh sửa ảnh selfie hoặc chân dung – không cần kỹ năng
                      chuyên nghiệp.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/ai-skin/uc_2.webp"
                    alt="Dễ dàng chỉnh sửa da trong ảnh"
                  ...
                  <div className="sm:pl-20 mt-4">
                    ...
                    <p className="sm:mb-8 mb-4 text-sm">
                      Công cụ chỉnh sửa da AI Skin cực kỳ dễ sử dụng trên điện
                      thoại iPhone, Samsung, máy tính bảng hoặc máy tính. Với
                      các thao tác đơn giản, điều hướng nhanh chóng, việc chỉnh
                      sửa ảnh trở nên thật nhẹ nhàng. Tuỳ chỉnh bức ảnh theo
                      cách bạn muốn!
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/ai-skin/uc_3.webp"
                    alt="Kết quả tự nhiên để chia sẻ"
                    className="order-2 max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Kết quả tự nhiên, hoàn hảo để chia sẻ
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Khác với các hiệu ứng chỉnh ảnh trông không tự nhiên, AI
                      Skin xuất sắc trong việc xóa mụn, chỉnh da nhưng vẫn giữ
                      lại chi tiết chân thực của khuôn mặt, tăng cường vẻ đẹp tự
                      nhiên của bạn. Điều này giúp bạn tự tin hơn khi đăng ảnh
                      lên mạng xã hội và không ai đoán được ảnh đã qua AI chỉnh
                      sửa.
                    </p>
                  </div>
                </div>
              ...
              <ul className="lg:mb-14 mb-10 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-24 lg:gap-y-8">
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Thuật toán tiên tiến giúp nhận diện và xóa mụn, tàn nhang một cách chính xác, và hòa da xung quanh một cách tự nhiên. Công cụ Chỉnh Sửa Da AI Skin trên SnapEdit nói không với việc chỉnh sửa quá mức."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Chỉnh Sửa Da Bằng AI
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Thuật toán tiên tiến giúp nhận diện và xóa mụn, tàn nhang
                      một cách chính xác, và hòa da xung quanh một cách tự
                      nhiên. Công cụ Chỉnh Sửa Da AI Skin trên SnapEdit nói
                      không với việc chỉnh sửa quá mức.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Kiểm soát hoàn toàn việc điều chỉnh tông da với các công cụ tinh chỉnh thủ công trên AI Skin. Bạn có thể giữ sự cân bằng giữa cường độ và tông màu trắng theo ý muốn."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Kiểm soát hoàn toàn việc điều chỉnh tông da với các công
                      cụ tinh chỉnh thủ công trên AI Skin. Bạn có thể giữ sự cân
                      bằng giữa cường độ và tông màu trắng theo ý muốn.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="SnapEdit cho phép người dùng chuyên nghiệp tải ảnh HD sắc nét trên mọi thiết bị hoặc bản in mà không làm giảm độ phân giải hay chi tiết."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit cho phép người dùng chuyên nghiệp tải ảnh HD sắc
                      nét trên mọi thiết bị hoặc bản in mà không làm giảm độ
                      phân giải hay chi tiết.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Ảnh của bạn được bảo mật với SnapEdit. Chúng tôi sử dụng mã hóa tiên tiến và tất cả các ảnh tải lên sẽ tự động bị xóa sau khi chỉnh sửa để đảm bảo quyền riêng tư của bạn."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Ảnh của bạn được bảo mật với SnapEdit. Chúng tôi sử dụng
                      mã hóa tiên tiến và tất cả các ảnh tải lên sẽ tự động bị
                      xóa sau khi chỉnh sửa để đảm bảo quyền riêng tư của bạn.
                    </p>
                  </div>
                </li>
              </ul>
          ...
          <div className="max-w-[1200px] m-auto tablet:px-10 mobile:px-4 lg:px-0">
            <div className="mb-6 text-center lg:mb-12">
              <h2 className="text-[#212B39] lg:text-[56px] lg:font-bold lg:leading-[72px] text-[32px] font-semibold leading-[44px]">
                Các Câu Hỏi Về Công Cụ Xóa Mụn Trên Ảnh AI
              </h2>
            </div>
            <ul className="border-t divide-y">
              <li>
                <button
                  ...
                  id="headlessui-disclosure-button-:r14s:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    AI Skin có thể xóa những khuyết điểm nào trên da?
                  </h3>
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r14u:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Mất bao lâu để chỉnh sửa một bức ảnh?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r150:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Công cụ Chỉnh Sửa Da AI có miễn phí không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r152:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Có giới hạn khi sử dụng công cụ AI Skin không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r154:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Mỗi lần chỉnh sửa bằng AI Skin tốn bao nhiêu tín dụng?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r156:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi muốn làn da sáng hơn, tôi nên làm gì?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r158:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể chỉnh sửa da trên điện thoại di động không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r15a:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    SnapEdit hỗ trợ định dạng ảnh nào?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
