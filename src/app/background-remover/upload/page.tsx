            ...
            <div className="mt-[64px] container lg:space-y-4">
              ...
              <div className="hidden lg:block">
                <div className="py-2 px-[10px] bg-blue-200 text-[#00349A] text-sm font-normal rounded flex items-center space-x-[10px]">
                  ...
                  <span>
                    Đừng quên tải xuống các tệp của bạn. Chúng sẽ bị loại bỏ tự
                    động sau 60 phút.
                  </span>
                </div>
              </div>
                ...
                <div className="rounded-xl shadow-md border bg-white border-[#ccc]">
                  <div className="lg:flex relative after:absolute after:left-0 after:bottom-0 after:w-full after:border-b grid grid-cols-2 border-[#ccc]">
                    <div className="lg:w-56 relative z-10">
                      <div className="font-semibold text-[14px] leading-[18px] flex items-center justify-center py-3 relative min-h-[44px] cursor-pointer text-center space-x-2  after:absolute after:w-full after:h-[2px] after:bg-blue-500 after:bg-blue-500 after:bottom-0 after:left-0 after:block text-blue-500">
                    ...
                    <div className="lg:w-56 relative z-10">
                      <div className="font-semibold text-[14px] leading-[18px] flex items-center justify-center py-3 relative min-h-[44px] cursor-pointer text-center space-x-2  after:absolute after:w-full after:h-[2px] after:bg-blue-500 after:bg-blue-500 after:bottom-0 after:left-0 after:hidden text-neutral-ink-500 border-[#ccc]">
                        <span className="inline-flex">
                          <div className="inline-block w-5">
                            <svg
                              className="w-full h-full"
                  ...
                  <div className="lg:min-h-[400px] lg:grid lg:grid-cols-9 border-[#ccc]">
                    <div className="lg:col-span-7 lg:border-r flex justify-center items-center p-4 lg:p-6 border-[#ccc]">
                      ...
                      <div
                        ...
                        style={{ background: "rgb(103, 2, 231)" }}
                      >
                        {" "}
                      ...
                      <div className="lg:mb-20">
                        <div className="hidden lg:px-3 lg:grid lg:grid-cols-6 lg:gap-2 items-end ">
                          <div className="col-span-1">
                            <button className="w-9 h-9 rounded-full border-2 cursor-pointer transition relative after:absolute after:w-8 after:h-8 after:rounded-full after:border-white after:border-2 after:left-0 after:top-0 hover:border-blue-500 hover:after:opacity-100 shadow-[0px_2px_8px_rgba(32,52,89,0.16)] border-white after:opacity-0 color-picker-transparent" />
                          </div>
                          <div className="col-span-1">
                            <div
                            ...
                            >
                              ...
                              />
                              <button className="w-9 h-9 rounded-full border-2 cursor-pointer transition relative after:absolute after:w-8 after:h-8 after:rounded-full after:border-white after:border-2 after:left-0 after:top-0 hover:border-blue-500 hover:after:opacity-100 shadow-[0px_2px_8px_rgba(32,52,89,0.16)] border-white after:opacity-0 color-picker-conic-gradient" />
                            </div>
                            <div
                              style={{
                                position: "fixed",
                          ...
                          <div className="col-span-1">
                            <button
                              className="w-9 h-9 rounded-full border-2 cursor-pointer transition relative after:absolute after:w-8 after:h-8 after:rounded-full after:border-white after:border-2 after:left-0 after:top-0 hover:border-blue-500 hover:after:opacity-100 shadow-[0px_2px_8px_rgba(32,52,89,0.16)] border-white after:opacity-0"
                          ...
                          <div className="col-span-1">
                            <button
                              className="w-9 h-9 rounded-full border-2 cursor-pointer transition relative after:absolute after:w-8 after:h-8 after:rounded-full after:border-white after:border-2 after:left-0 after:top-0 hover:border-blue-500 hover:after:opacity-100 shadow-[0px_2px_8px_rgba(32,52,89,0.16)] border-blue-500 after:opacity-100"
