          ...
          <div className="container pt-[90px] space-y-6 lg:relative lg:space-y-0 lg:min-h-[700px] lg:pt-[160px] lg:flex lg:justify-between lg:items-start">
            <div className="lg:pr-4">
              <h1 className="text-neutral-ink-700 mb-4 text-center lg:text-left !leading-tight H30B lg:H56B">
                Enhancer - Làm nét ảnh trực tuyến{" "}
                <div className="block w-fit relative after:absolute after:bg-[#27FFFF] after:left-0 after:bottom-1.5 lg:after:bottom-2 after:w-full after:h-2 lg:after:h-3 mx-auto mt-2 lg:mx-0 lg:mt-0">
                  <span className="relative z-10">bằng AI</span>
                </div>
              </h1>
              <p className="text-neutral-ink-600 text-center lg:text-left T16R lg:T20R">
                Công cụ làm nét hình ảnh online tốt nhất với công nghệ AI.
              </p>
              <div className="mt-4 sm:block hidden">
                <img src="https://assets.snapedit.app/images/enhance/hero_banner_static.png" />
              </div>
            </div>
          ...
          <div className="container pb-5 lg:pb-0">
            <div className="text-center lg:mb-12 mb-7">
              <h2 className="snap-block-heading">
                Cách làm nét chất lượng ảnh bằng SnapEdit
              </h2>
              <div className="text-neutral-ink-600 lg:w-2/3 lg:mx-auto T14R lg:T16R">
                <p>
                  Bạn có thể sử dụng{" "}
                  <a href="https://snapedit.app/vi/enhance">
                    <b>làm nét ảnh</b>
                  </a>{" "}
                  trực tuyến với SnapEdit để cải thiện chất lượng hiển thị của
                  bất kỳ hình ảnh nào chỉ với 3 bước đơn giản sau đây:{" "}
                </p>
              </div>
            </div>
            <div className="regular slider lg:grid lg:gap-9 lg:grid-cols-3">
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/enhance/Step_1.png"
                  alt="Tải ảnh lên SnapEdit"
                ...
                <div>
                  <h3 className="font-semibold mb-4">
                    ...
                    <span className="font-semibold text-[14px] leading-[18px] align-middle inline-block">
                      Tải ảnh lên SnapEdit
                    </span>
                  </h3>
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Nhấp vào TẢI ẢNH LÊN hoặc kéo và thả ảnh bạn muốn vào phần
                    tải lên.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/enhance/Step_2.png"
                  alt="So sánh & điều chỉnh:"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  <h3 className="font-semibold mb-4">
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    So sánh trước và sau, thực hiện các điều chỉnh cần thiết để
              ...
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/enhance/Step_3.png"
                ...
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Điều chỉnh kích thước của hình ảnh làm nét và tải xuống.
                    Đẹp, nhanh và miễn phí!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl banner-gradient sm:py-10 sm:px-14 sm:flex sm:justify-between sm:items-center px-4 py-6 text-center">
              <div className="mb-4 sm:flex-1">
                ...
                <p className="font-normal text-base-content px-2 sm:w-3/4">
                  Ứng dụng SnapEdit hiện có trên Apple Store &amp; Google Play
                  Store. Ứng dụng của chúng tôi đã được người dùng trên khắp thế
                  giới sử dụng để làm nét chất lượng ảnh.
                </p>
              </div>
          ...
          <div className="bg-[#F8FAFD] lg:pt-24 lg:pb-[120px] py-12">
            <div className="container">
              <h2 className="leading-normal lg:w-3/4 H30B lg:H56B">
                Bộ công cụ làm nét ảnh AI tất cả trong một{" "}
              ...
              <div className="space-y-12 pt-10 lg:pt-[72px] lg:space-y-16">
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/enhance/feat_1.webp"
                    alt="Snapedit giúp làm sắc nét ảnh"
                  ...
                  <div className="sm:pr-20 mt-4">
                    ...
                    <p className="sm:mb-8 mb-4 text-sm">
                      Làm sắc nét và làm rõ ảnh mờ trong bức hình của bạn để nó
                      trở lên nổi bật và sắc nét hơn.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/enhance/feat_2.webp"
                    alt="Chỉnh sửa ảnh sản phẩm để cải thiện chất lượng"
                  ...
                  <div className="sm:pl-20 mt-4">
                    ...
                    <p className="sm:mb-8 mb-4 text-sm">
                      Làm nét hình ảnh sản phẩm trong vài giây, khiến chúng trở
                      nên hấp dẫn hơn và đạt được lợi thế đáng kể so với các đối
                      thủ cạnh tranh.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/enhance/feat_3.webp"
                    alt="Sửa chữa và làm nét ảnh cũ"
                    className="order-2 max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Khử nhiễu &amp; sửa ảnh cũ
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Thao tác đơn giản, nhanh chóng giúp khôi phục ảnh cũ như
                      mới chụp hôm qua.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/enhance/feat_4.webp"
                    alt="Cải thiện chất lượng ảnh minh họa và thiết kế đồ họa"
                    className="max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pl-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                    ...
                    <p className="sm:mb-8 mb-4 text-sm">
                      Thêm chi tiết cho các ảnh thiết kế đồ họa kém chất lượng
                      với công cụ làm nét ảnh AI.{" "}
                      <b>
                        Linh hoạt điều chỉnh độ nét sao cho ảnh thật tự nhiên
                      </b>{" "}
                      so với bản gốc.
                    </p>
                  </div>
                ...
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/enhance/feat_5.webp"
                    alt="Nâng cấp hình ảnh nghệ thuật"
                    className="order-2 max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                    ...
                    <p className="sm:mb-8 mb-4 text-sm">
                      Làm nét ảnh anime, manga, waifu, hoạt hình, bản vẽ và hình
                      ảnh gen bằng AI để in ấn và trưng bày.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/enhance/feat_6.webp"
                    alt="Mang lại sức sống mới cho ảnh phong cảnh"
                    className="max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pl-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Cải thiện ảnh chụp phong cảnh
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Làm rõ và thêm các chi tiết cho ảnh phong cảnh chụp bị mờ.
                      Ngoài chế độ tự động, bạn có thể sử dụng câu lệnh để hướng
                      dẫn AI làm nét sao cho giống với ảnh gốc nhiều nhất.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <ul className="lg:mb-14 mb-10 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-24 lg:gap-y-8">
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="SnapEdit miễn phí sử dụng. Bạn không cần phải trả bất cứ điều gì để làm nét hình ảnh với chúng tôi."
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit miễn phí sử dụng. Bạn không cần phải trả bất cứ
                      điều gì để làm nét hình ảnh với chúng tôi.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="SnapEdit tự động làm sắc nét và ,[object Object],. Nhưng bạn cũng có thể điều chỉnh và thêm hướng dẫn cho AI để cá nhân hóa kết quả."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Đa dạng tùy chọn chỉnh sửa
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit tự động làm sắc nét và{" "}
                      <a href="https://snapedit.app/">chỉnh sửa ảnh với AI</a>.
                      Nhưng bạn cũng có thể điều chỉnh và thêm hướng dẫn cho AI
                ...
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Làm nét, chỉnh sửa, thay đổi kích thước và tải xuống ảnh của bạn trong vài giây."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Làm nét, chỉnh sửa, thay đổi kích thước và tải xuống ảnh
                ...
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="SnapEdit có sẵn trên các cửa hàng iOS và Android. Ứng dụng của chúng tôi hoạt động hiệu quả trên thiết bị di động, máy tính để bàn và máy tính bảng."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit có sẵn trên các cửa hàng iOS và Android. Ứng dụng
                      của chúng tôi hoạt động hiệu quả trên thiết bị di động,
          ...
          <div className="max-w-[1200px] m-auto tablet:px-10 mobile:px-4 lg:px-0">
            <div className="mb-6 text-center lg:mb-12">
              <h2 className="text-[#212B39] lg:text-[56px] lg:font-bold lg:leading-[72px] text-[32px] font-semibold leading-[44px]">
                Câu hỏi thường gặp về công cụ làm nét ảnh trực tuyến
              </h2>
            </div>
            <ul className="border-t divide-y">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r9p:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tại sao tôi nên sử dụng SnapEdit?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r9r:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Làm cách nào để làm nét chất lượng ảnh trực tuyến?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r9t:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Bất kỳ hình ảnh nào cũng có thể tăng độ nét ảnh online đúng
                    không ?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:r9v:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể sử dụng SnapEdit trên thiết bị Android không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:ra1:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
