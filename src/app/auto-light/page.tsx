          ...
          <div className="container pt-[90px] space-y-6 lg:relative lg:space-y-0 lg:min-h-[700px] lg:pt-[160px] lg:flex lg:justify-between lg:items-start">
            <div className="lg:pr-4">
              <h1 className="text-neutral-ink-700 mb-4 text-center lg:text-left !leading-tight H30B lg:H56B">
                Làm Sáng Ảnh Trực Tuyến Miễn Phí{" "}
              ...
              <p className="text-neutral-ink-600 text-center lg:text-left T16R lg:T20R">
                Biến những bức ảnh tối thành những hình ảnh sống động với công
                cụ làm sáng ảnh trí tuệ nhân tạo của chúng tôi - AutoLight
              </p>
              <div className="mt-4 sm:block hidden">
                <img
                  src="https://assets.snapedit.app/images/auto-light/hero_banner_static.png"
                    ...
                    <ul className="space-x-3">
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/auto-light/demo-1.jpg"
                            alt="sample"
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/auto-light/demo-2.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/auto-light/demo-3.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
                      ...
                      <li className="inline-block">
                        <button className="w-12 h-12 overflow-hidden transition rounded hover:opacity-80">
                          <img
                            src="https://assets.snapedit.app/images/auto-light/demo-4.jpg"
                            alt="sample"
                            className="object-cover w-full h-full"
                          />
                        </button>
          ...
          <div className="container pb-5 lg:pb-0">
            <div className="text-center lg:mb-12 mb-7">
              <h2 className="snap-block-heading">
                Cách làm sáng ảnh trực tuyến bằng SnapEdit AutoLight?
              </h2>
              <div className="text-neutral-ink-600 lg:w-2/3 lg:mx-auto T14R lg:T16R">
                <p>
                  Biến những bức ảnh tối của bạn thành những bức ảnh sáng chỉ
                  cách 3 bước{" "}
                </p>
              </div>
            </div>
            <div className="regular slider lg:grid lg:gap-9 lg:grid-cols-3">
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/auto-light/Step_1.jpg"
                  alt="1. Tải lên ảnh"
                ...
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Nhấn vào nút tải lên, kéo và thả hoặc nhấn Ctrl + V để đưa
                    ảnh của bạn vào trình chỉnh sửa SnapEdit AutoLight
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/auto-light/Step_2.jpg"
                  alt="2. Trí tuệ nhân tạo tự động làm sáng ảnh"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  <h3 className="font-semibold mb-4">
                    ...
                    <span className="font-semibold text-[14px] leading-[18px] align-middle inline-block">
                      2. Trí tuệ nhân tạo tự động làm sáng ảnh
                    </span>
                  </h3>
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Sau khi ảnh được tải lên thành công, AutoLight sẽ tự động
                    làm sáng ảnh. Bạn có thể so sánh kết quả trước và sau để
                    thấy sự kỳ diệu.
                  </p>
                </div>
              </div>
              <div className="bg-white inline-block w-full px-2 align-top whitespace-normal">
                <img
                  src="https://assets.snapedit.app/images/auto-light/Step_3.jpg"
                  alt="3. Tải xuống ảnh"
                  className="w-full mb-4 rounded-xl"
                />
                <div>
                  ...
                  <p className="font-normal text-[14px] leading-[20px] text-neutral-ink-600">
                    Lưu bức ảnh mới đã được làm sáng vào thiết bị của bạn bằng
                    cách nhấn vào nút <b>Tải xuống</b>.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl banner-gradient sm:py-10 sm:px-14 sm:flex sm:justify-between sm:items-center px-4 py-6 text-center">
              <div className="mb-4 sm:flex-1">
                ...
                <p className="font-normal text-base-content px-2 sm:w-3/4">
                  ...
                  trên khắp thế giới để làm sắc nét các bức ảnh.
                </p>
              </div>
          ...
          <div className="bg-[#F8FAFD] lg:pt-24 lg:pb-[120px] py-12">
            <div className="container">
              <h2 className="leading-normal lg:w-3/4 H30B lg:H56B">
                Công cụ làm sáng ảnh bằng trí tuệ nhân tạo làm sống lại những
                bức ảnh tối như{" "}
              ...
              <div className="space-y-12 pt-10 lg:pt-[72px] lg:space-y-16">
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/auto-light/feat_1.jpg"
                    alt="Trí tuệ nhân tạo tự động sửa độ sáng của các bức ảnh"
                  ...
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Sửa đổi độ sáng của bất kỳ bức ảnh nào một cách tự nhiên
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      AutoLight đã trải qua hàng ngàn thử nghiệm để{" "}
                      <b>làm sáng ảnh</b>. Nó cải thiện độ sáng để hiện ra những
                      chi tiết ẩn hoặc khó nhìn trong những bức ảnh tối hoặc bị
                      thiếu sáng.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/auto-light/feat_2.jpg"
                    alt="Làm sáng ảnh để nâng cao tâm trạng"
                    className="max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pl-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Nâng cao tâm trạng và tông màu cho ảnh
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Những bức ảnh sáng, sống động gợi lên nhiều cảm xúc tích
                      cực và sự ấm áp hơn so với những bức ảnh tối, mờ mờ. Hãy
                      thay đổi cảm giác của khán giả khi họ xem ảnh của bạn.
                    </p>
                  </div>
                </div>
                <div className="sm:flex sm:justify-between sm:items-center text-base-content-primary">
                  <img
                    src="https://assets.snapedit.app/images/auto-light/feat_3.jpg"
                    alt="Nhận nhiều lượt thích cho những bức ảnh sáng hơn
"
                    className="order-2 max-w-[528px] w-full rounded-2xl"
                  />
                  <div className="sm:pr-20 mt-4">
                    <h3 className="sm:text-[32px] text-xl font-semibold sm:mb-4 mb-2">
                      Ảnh sáng hơn, nhiều lượt thích hơn
                    </h3>
                    <p className="sm:mb-8 mb-4 text-sm">
                      Sau khi làm sáng ảnh, sự tập trung của mắt tự nhiên được
                      hướng vào các điểm chính của các đối tượng. Hãy tự tin
                      đăng ảnh của bạn bất cứ nơi nào để nhận nhiều lượt thích
                      hơn.
                    </p>
                  </div>
                </div>
              ...
              <ul className="lg:mb-14 mb-10 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-24 lg:gap-y-8">
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="SnapEdit AutoLight cung cấp tất cả những gì bạn cần trong một công cụ làm sáng ảnh trí tuệ nhân tạo, bao gồm các thuật toán tiên tiến, tốc độ nhanh, tính đồng đều của tông màu, điều khiển trực quan, tính ổn định và nhiều tính năng khác."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Công cụ làm sáng ảnh toàn diện
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      SnapEdit AutoLight cung cấp tất cả những gì bạn cần trong
                      một công cụ làm sáng ảnh trí tuệ nhân tạo, bao gồm các
                      thuật toán tiên tiến, tốc độ nhanh, tính đồng đều của tông
                      màu, điều khiển trực quan, tính ổn định và nhiều tính năng
                      khác.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Ai cũng có thể biến một bức ảnh tối thành một bức ảnh sáng mà không cần kỹ năng Photoshop. Trí tuệ nhân tạo tùy chỉnh điều chỉnh độ sáng cần thiết chỉ với một cú nhấp chuột."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Làm cho việc làm sáng ảnh trực tuyến trở nên dễ dàng
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Ai cũng có thể biến một bức ảnh tối thành một bức ảnh sáng
                      mà không cần kỹ năng Photoshop. Trí tuệ nhân tạo tùy chỉnh
                      điều chỉnh độ sáng cần thiết chỉ với một cú nhấp chuột.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Hãy thoải mái ,[object Object], và sẵn sàng nâng cấp lên gói Pro để chỉnh sửa với các tính năng cao cấp hơn mà không bị giới hạn."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                    ...
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Hãy thoải mái <b>làm sáng ảnh trực tuyến</b> và sẵn sàng
                      nâng cấp lên gói Pro để chỉnh sửa với các tính năng cao
                      cấp hơn mà không bị giới hạn.
                    </p>
                  </div>
                </li>
                <li className="space-x-5 items-start flex lg:space-x-6 lg:p-4">
                  <img
                    ...
                    alt="Trang web để làm sáng ảnh tương thích với mọi thiết bị. Cho dù bạn đang sử dụng điện thoại thông minh, máy tính xách tay, máy tính để bàn hoặc máy tính bảng, nó hoạt động mượt mà."
                    className="w-14 lg:w-auto"
                  />
                  <div className="space-y-2">
                    <h3 className="font-semibold text-[20px] leading-[28px] tracking-[0.02em] text-white">
                      Làm sáng ảnh trên tất cả thiết bị của bạn một cách tốt
                      nhất
                    </h3>
                    <p className="font-normal text-[16px] leading-[24px] text-neutral-ink-200">
                      Trang web để làm sáng ảnh tương thích với mọi thiết bị.
                      Cho dù bạn đang sử dụng điện thoại thông minh, máy tính
                      xách tay, máy tính để bàn hoặc máy tính bảng, nó hoạt động
                      mượt mà.
                    </p>
                  </div>
                </li>
          ...
          <div className="max-w-[1200px] m-auto tablet:px-10 mobile:px-4 lg:px-0">
            <div className="mb-6 text-center lg:mb-12">
              <h2 className="text-[#212B39] lg:text-[56px] lg:font-bold lg:leading-[72px] text-[32px] font-semibold leading-[44px]">
                Câu hỏi thường gặp về công cụ làm sáng ảnh SnapEdit
              </h2>
            </div>
            <ul className="border-t divide-y">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rrk:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    SnapEdit AutoLight hoạt động như thế nào?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rrm:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Điều gì làm nên sự khác biệt của SnapEdit AutoLight so với
                    các công cụ làm sáng ảnh khác?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rro:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    SnapEdit AutoLight có an toàn không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rrq:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Làm thế nào để làm sáng ảnh bằng AutoLight?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rrs:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Các định dạng ảnh nào được công cụ làm sáng ảnh SnapEdit hỗ
                    trợ?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rru:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    Tôi có thể làm sáng ảnh trên iPhone của mình bằng SnapEdit
                    không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
              ...
              <li>
                <button
                  className="flex items-center justify-between w-full px-5 py-4 bg-gradient-to-b from-zinc-100 to-zinc-100"
                  id="headlessui-disclosure-button-:rs0:"
                  type="button"
                  aria-expanded="false"
                  data-headlessui-state=""
                >
                  <h3 className="block pr-4 font-semibold text-left text-[18px] text-neutral-ink-600">
                    SnapEdit AutoLight có miễn phí không?
                  </h3>
                  <div className="w-4 text-neutral">
                    <div className="inline-block">
                      <svg
